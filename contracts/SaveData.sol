...
contract SaveData {
    ...
    function saveData(
        ...
        data[totalMedicalReports]
            .secondTimeEncryptedString = secondTimeEncryptedString;
        data[totalMedicalReports]
            .hashOfOriginalDataString = hashOfOriginalDataString;
        data[totalMedicalReports].sender = msg.sender;
        data[totalMedicalReports].medReportId = medReportId;

        senders[msg.sender].data[
            senders[msg.sender].totalMedicalReports++
        ] = totalMedicalReports++;
    }
}
